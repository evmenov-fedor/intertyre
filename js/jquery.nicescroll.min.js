(function (a) {
    ...
    var c = {zindex: "auto", cursoropacitymin: 0, cursoropacitymax: 1, cursorcolor: "#424242", cursorwidth: "5px", cursorborder: "1px solid #fff", cursorborderradius: "5px", scrollspeed: 60, mousescrollstep: 8 * 3, touchbehavior: false, hwacceleration: true, usetransition: true, boxzoom: false, dblclickzoom: true, gesturezoom: true, grabcursorenabled: true, autohidemode: true, background: "", iframeautoresize: true, cursorminheight: 32, preservenativescrolling: true, railoffset: false, bouncescroll: true, spacebarenabled: true, railpadding: {top: 0, right: 0, left: 0, bottom: 0}, disableoutline: true, horizrailenabled: true, railalign: "right", railvalign: "bottom", enabletranslate3d: true, enablemousewheel: true, enablekeyboard: true, smoothscroll: true, sensitiverail: true, enablemouselockapi: true, cursorfixedheight: false, directionlockdeadzone: 6, hidecursordelay: 400, nativeparentscrolling: true, enablescrollonselection: true, overflowx: true, overflowy: true, cursordragspeed: 0.3, rtlmode: "auto", cursordragontouch: false, oneaxismousemode: "auto", scriptpath: x()};
    var j = false;
    var u = function () {
        if (j) {
            return j
    ...
    var b = function (A, E) {
        ...
        this.delayed = function (O, Q, N, P) {
            ...
            if (L && L.last + N > M && !L.tt) {
                J.delaylist[O] = {last: M + N, tt: setTimeout(function () {
                    if (J || false) {
                        J.delaylist[O].tt = 0;
                        Q.call()
                    }
        ...
        BezierClass.prototype = {B2: function (L) {
            return 3 * L * L * (1 - L)
        }, B3: function (L) {
            return 3 * L * (1 - L) * (1 - L)
        }, B4: function (L) {
        ...
        this.getOffset = function () {
            if (J.isfixed) {
                return{top: parseFloat(J.win.css("top")), left: parseFloat(J.win.css("left"))}
            }
            if (!J.viewport) {
                return J.win.offset()
            }
            ...
            return{top: M.top - L.top + J.viewport.scrollTop(), left: M.left - L.left + J.viewport.scrollLeft()}
        };
        this.updateScrollBar = function (M) {
            if (J.ishwscroll) {
                J.rail.css({height: J.win.innerHeight()});
                if (J.railh) {
                    J.railh.css({width: J.win.innerWidth()})
                }
            } else {
                var N = J.getOffset();
                var R = {top: N.top, left: N.left};
                ...
                if (!J.locked) {
                    J.rail.css({top: R.top, left: R.left, height: (M) ? M.h : J.win.innerHeight()})
                }
                if (J.zoom) {
                    J.zoom.css({top: R.top + 1, left: (J.rail.align == 1) ? R.left - 20 : R.left + J.rail.width + 4})
                }
                if (J.railh && !J.locked) {
                    var R = {top: N.top, left: N.left};
                    ...
                    J.railh.css({top: P, left: L, width: J.railh.width})
                }
            }
        };
        ...
        this.init = function () {
            ...
            if (I.hasmstouch) {
                J.css((J.ispage) ? e("html") : J.win, {"-ms-touch-action": "none"})
            }
            J.zindex = "auto";
            ...
            if (!J.ispage || (!I.cantouch && !I.isieold && !I.isie9mobile)) {
                ...
                if (!I.isie9mobile) {
                    J.css(P, {"overflow-y": "hidden"})
                }
                if (J.ispage && I.isie7) {
                    if (J.doc[0].nodeName == "BODY") {
                        J.css(e("html"), {"overflow-y": "hidden"})
                    } else {
                        if (J.doc[0].nodeName == "HTML") {
                            J.css(e("body"), {"overflow-y": "hidden"})
                        }
                    }
                }
                if (I.isios && !J.ispage && !J.haswrapper) {
                    J.css(e("body"), {"-webkit-overflow-scrolling": "touch"})
                }
                var Q = e(document.createElement("div"));
                Q.css({position: "relative", top: 0, "float": "right", width: J.opt.cursorwidth, height: "0px", "background-color": J.opt.cursorcolor, border: J.opt.cursorborder, "background-clip": "padding-box", "-webkit-border-radius": J.opt.cursorborderradius, "-moz-border-radius": J.opt.cursorborderradius, "border-radius": J.opt.cursorborderradius});
                ...
                O.css({width: O.width + "px", zIndex: J.zindex, background: J.opt.background, cursor: "default"});
                O.visibility = true;
                O.scrollable = true;
                ...
                if (J.opt.boxzoom && !J.ispage && !I.isieold) {
                    ...
                    J.zoom = e(L);
                    J.zoom.css({cursor: "pointer", "z-index": J.zindex, backgroundImage: "url(" + J.opt.scriptpath + "zoomico.png)", height: 18, width: 18, backgroundPosition: "0px 0px"});
                ...
                if (J.opt.horizrailenabled) {
                    J.css(P, {"overflow-x": "hidden"});
                    var Q = e(document.createElement("div"));
                    Q.css({position: "relative", top: 0, height: J.opt.cursorwidth, width: "0px", "background-color": J.opt.cursorcolor, border: J.opt.cursorborder, "background-clip": "padding-box", "-webkit-border-radius": J.opt.cursorborderradius, "-moz-border-radius": J.opt.cursorborderradius, "border-radius": J.opt.cursorborderradius});
                    ...
                    T.css({height: T.height + "px", zIndex: J.zindex, background: J.opt.background});
                    T.append(Q);
                    T.visibility = true;
                    T.scrollable = true;
                ...
                if (J.ispage) {
                    O.css({position: "fixed", top: "0px", height: "100%"});
                    (O.align) ? O.css({right: "0px"}) : O.css({left: "0px"});
                    J.body.append(O);
                    if (J.railh) {
                        T.css({position: "fixed", left: "0px", width: "100%"});
                        (T.align) ? T.css({bottom: "0px"}) : T.css({top: "0px"});
                        J.body.append(T)
                    }
                } else {
                    if (J.ishwscroll) {
                        if (J.win.css("position") == "static") {
                            J.css(J.win, {position: "relative"})
                        }
                        var R = (J.win[0].nodeName == "HTML") ? J.body : J.win;
                        if (J.zoom) {
                            J.zoom.css({position: "absolute", top: 1, right: 0, "margin-right": O.width + 4});
                            R.append(J.zoom)
                        }
                        O.css({position: "absolute", top: 0});
                        (O.align) ? O.css({right: 0}) : O.css({left: 0});
                        R.append(O);
                        if (T) {
                        ...
                        if (J.viewport) {
                            ...
                            if ((/fixed|relative|absolute/.test(J.viewport.css("position"))) == false) {
                                J.css(J.viewport, {position: "relative"})
                            }
                        }
                        O.css({position: X});
                        if (J.zoom) {
                            J.zoom.css({position: X})
                        }
                        J.updateScrollBar();
                        J.body.append(O);
                        if (J.zoom) {
                    ...
                    if (I.isios) {
                        J.css(J.win, {"-webkit-tap-highlight-color": "rgba(0,0,0,0)", "-webkit-touch-callout": "none"})
                    }
                    if (I.isie && J.opt.disableoutline) {
                        J.win.attr("hideFocus", "true")
                    }
                    if (I.iswebkit && J.opt.disableoutline) {
                        J.win.css({outline: "none"})
                    }
                }
                if (J.opt.autohidemode === false) {
                    J.autohidedom = false;
                    J.rail.css({opacity: J.opt.cursoropacitymax});
                    if (J.railh) {
                        J.railh.css({opacity: J.opt.cursoropacitymax})
                    }
                } else {
                ...
                if (I.isie9mobile) {
                    ...
                    J.mangotouch = {sy: V, ly: V, dry: 0, sx: ab, lx: ab, drx: 0, lazy: false, tm: 0};
                    ...
                    if (I.cantouch || J.istouchcapable || J.opt.touchbehavior || I.hasmstouch) {
                        ...
                        J.ontouchstart = function (ai) {
                            ...
                            if (!J.locked) {
                                ...
                                if (J.forcescreen) {
                                    var ad = ai;
                                    var ai = {original: (ai.original) ? ai.original : ai};
                                    ai.clientX = ad.screenX;
                                    ai.clientY = ad.screenY
                                }
                                J.rail.drag = {x: ai.clientX, y: ai.clientY, sx: J.scroll.x, sy: J.scroll.y, st: J.getScrollTop(), sl: J.getScrollLeft(), pt: 2, dl: false};
                                if (J.ispage || !J.opt.directionlockdeadzone) {
                                    J.rail.drag.dl = "f"
                                } else {
                                    var am = {w: e(window).width(), h: e(window).height()};
                                    var aj = {w: Math.max(document.body.scrollWidth, document.documentElement.scrollWidth), h: Math.max(document.body.scrollHeight, document.documentElement.scrollHeight)};
                        ...
                        J.ontouchmove = function (al, ah) {
                            ...
                            if (J.rail.drag && (J.rail.drag.pt == 2)) {
                                ...
                                var am = e.extend({original: al}, al);
                                al = am;
                                ...
                                if (J.forcescreen) {
                                    var ae = al;
                                    var al = {original: (al.original) ? al.original : al};
                    ...
                    J.onmousedown = function (af, ad) {
                        ...
                        J.cancelScroll();
                        J.rail.drag = {x: af.clientX, y: af.clientY, sx: J.scroll.x, sy: J.scroll.y, pt: 1, hr: (!!ad)};
                        ...
                        if (J.isiframe && !I.hasmousecapture) {
                            ...
                            J.css(J.doc, {"pointer-events": "none"})
                        }
                        J.hasmoving = false;
                        return J.cancelEvent(af)
                    };
                    ...
                    if (I.cantouch || J.opt.touchbehavior) {
                        ...
                        if (J.opt.grabcursorenabled && I.cursorgrabvalue) {
                            J.css((J.ispage) ? J.doc : J.win, {cursor: I.cursorgrabvalue});
                            J.css(J.rail, {cursor: I.cursorgrabvalue})
                        }
                    } else {
                        function N(af) {
                            if (!J.selectiondrag) {
                    ...
                    if (I.hasmstouch) {
                        J.css(J.rail, {"-ms-touch-action": "none"});
                        J.css(J.cursor, {"-ms-touch-action": "none"});
                    ...
                    if (J.opt.cursordragontouch || !I.cantouch && !J.opt.touchbehavior) {
                        J.rail.css({cursor: "default"});
                        J.railh && J.railh.css({cursor: "default"});
                ...
                if (!J.ispage && !J.haswrapper) {
                    if (p !== false) {
                        ...
                        J.observer.observe(J.win[0], {childList: true, characterData: false, attributes: true, subtree: false});
                        ...
                        J.observerremover.observe(J.win[0].parentNode, {childList: true, characterData: false, attributes: false, subtree: false})
                    } else {
            ...
            if (this.doc[0].nodeName == "IFRAME") {
                function S(ag) {
                    ...
                    J.forcescreen = true;
                    if (J.isiframe) {
                        J.iframe = {doc: e(af), html: J.doc.contents().find("html")[0], body: J.doc.contents().find("body")[0]};
                        J.getContentSize = function () {
                            return{w: Math.max(J.iframe.html.scrollWidth, J.iframe.body.scrollWidth), h: Math.max(J.iframe.html.scrollHeight, J.iframe.body.scrollHeight)}
                        };
                    ...
                    J.lazyResize(30);
                    if (I.isie7) {
                        J.css(e(J.iframe.html), {"overflow-y": "hidden"})
                    }
                    J.css(e(J.iframe.body), {"overflow-y": "hidden"});
                    if (I.isios && J.haswrapper) {
                        J.css(e(af.body), {"-webkit-transform": "translate3d(0,0,0)"})
                    }
                    ...
                    if (I.cantouch || J.opt.touchbehavior) {
                        ...
                        if (J.opt.grabcursorenabled && I.cursorgrabvalue) {
                            J.css(e(af.body), {cursor: I.cursorgrabvalue})
                        }
                    }
        ...
        this.showCursor = function (L, M) {
            ...
            if (J.autohidedom) {
                J.autohidedom.stop().css({opacity: J.opt.cursoropacitymax});
                J.cursoractive = true
            }
            if (!J.rail.drag || J.rail.drag.pt != 1) {
            ...
            J.cursor.css({height: J.cursorheight, top: J.scroll.y});
            if (J.cursorh) {
                (!J.rail.align && J.rail.visibility) ? J.cursorh.css({width: J.cursorwidth, left: J.scroll.x + J.rail.width}) : J.cursorh.css({width: J.cursorwidth, left: J.scroll.x});
                J.cursoractive = true
            }
            if (J.zoom) {
                J.zoom.stop().css({opacity: J.opt.cursoropacitymax})
            }
        };
        this.hideCursor = function (L) {
            ...
            J.cursortimeout = setTimeout(function () {
                if (!J.rail.active || !J.showonmouseevent) {
                    J.autohidedom.stop().animate({opacity: J.opt.cursoropacitymin});
                    if (J.zoom) {
                        J.zoom.stop().animate({opacity: J.opt.cursoropacitymin})
                    }
        ...
        this.getContentSize = (J.ispage) ? function () {
            ...
            return{w: J.doc.outerWidth() + parseInt(J.win.css("paddingLeft")) + parseInt(J.win.css("paddingRight")), h: J.doc.outerHeight() + parseInt(J.win.css("paddingTop")) + parseInt(J.win.css("paddingBottom"))}
        } : function () {
            return{w: J.docscroll[0].scrollWidth, h: J.docscroll[0].scrollHeight}
        };
        this.onResize = function (P, N) {
            ...
            var S = J.page.maxh;
            var M = J.page.maxw;
            var O = {h: J.view.h, w: J.view.w};
            J.view = {w: (J.ispage) ? J.win.width() : parseInt(J.win[0].clientWidth), h: (J.ispage) ? J.win.height() : parseInt(J.win[0].clientHeight)};
            ...
            J.scrollratio = {x: (J.page.maxw / J.scrollvaluemaxw), y: (J.page.maxh / J.scrollvaluemax)};
        ...
        function v(O, M, N, L) {
            J._bind(O, M, function (Q) {
                ...
                var P = {original: Q, target: Q.target || Q.srcElement, type: "wheel", deltaMode: Q.type == "MozMousePixelScroll" ? 0 : 1, deltaX: 0, deltaZ: 0, preventDefault: function () {
        ...
        this._bind = function (O, M, N, L) {
            J.events.push({e: O, n: M, f: N, b: L, q: false});
        ...
        this.jqbind = function (N, L, M) {
            J.events.push({e: N, n: L, f: M, q: true});
            e(N).bind(L, M)
        };
        ...
        this.triggerScrollEnd = function () {
            ...
            var N = {type: "scrollend", current: {x: M, y: L}, end: {x: M, y: L}};
            ...
            if (J.ishwscroll && I.hastransition && J.opt.usetransition) {
                    ...
                    J.timer = setTimeout(function () {
                        ...
                        if (S > 0) {
                            if (!J.scrollrunning && J.onscrollstart) {
                                var V = {type: "scrollstart", current: {x: U, y: W}, request: {x: L, y: P}, end: {x: J.newscrollx, y: J.newscrolly}, speed: S};
                            ...
                            var R = W;
                            var T = U;
                            J.timerscroll = {bz: new BezierClass(R, J.newscrolly, S, 0, 0, 0.58, 1), bh: new BezierClass(T, J.newscrollx, S, 0, 0, 0.58, 1)};
                            if (!J.cursorfreezed) {
                ...
                this.doScrollPos = function (U, S, Q) {
                    ...
                    if (J.onscrollstart && !J.scrollrunning) {
                        var M = {type: "scrollstart", current: {x: W, y: T}, request: {x: U, y: S}, end: {x: J.newscrollx, y: J.newscrolly}, speed: L};
        ...
        this.doZoomIn = function (Q) {
            ...
            J.zoomrestore.padding = {w: J.win.outerWidth() - J.win.width(), h: J.win.outerHeight() - J.win.height()};
            if (I.isios4) {
                J.zoomrestore.scrollTop = e(window).scrollTop();
                e(window).scrollTop(0)
            }
            J.win.css({position: (I.isios4) ? "absolute" : "fixed", top: 0, left: 0, "z-index": d + 100, margin: "0px"});
            var O = J.win.css("backgroundColor");
            if (O == "" || /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(O)) {
                J.win.css("backgroundColor", "#fff")
            }
            J.rail.css({"z-index": d + 101});
            J.zoom.css({"z-index": d + 102});
        ...
        this.doZoomOut = function (L) {
            ...
            J.rail.css({"z-index": J.zindex});
            J.zoom.css({"z-index": J.zindex});
            J.zoomrestore = false;
        ...
        this.resizeZoom = function () {
            ...
            var L = J.getScrollTop();
            J.win.css({width: e(window).width() - J.zoomrestore.padding.w + "px", height: e(window).height() - J.zoomrestore.padding.h + "px"});
            J.onResize();
    ...
    m.cssHooks.pageYOffset = {get: function (B, A, v) {
    ...
    e.cssHooks.pageXOffset = {get: function (B, A, v) {
        var z = e.data(B, "__nicescroll") || false;
    ...
    m.extend(m.expr[":"], {nicescroll: function (v) {
